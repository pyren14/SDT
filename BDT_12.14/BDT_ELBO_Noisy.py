...
class BayesianDecisionTree:
    def __init__(self, max_depth=16, min_samples_split=10, learning_rate=0.01, n_steps=10):
...
if __name__ == "__main__":
    ...
    bdt = BayesianDecisionTree(max_depth=16, min_samples_split=10, learning_rate=0.01, n_steps=10)
